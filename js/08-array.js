...
// ! можно записывать вертикальное, если это повысит читаемость кода
const anyArray = [
    3,
    '543',
    true,
...
console.log(anyArray[3][2]);




// ! Рефакторинг цикла for для массива
// ! Копирование массива

// Решать всё, кроме 25-29, 35-до конца
